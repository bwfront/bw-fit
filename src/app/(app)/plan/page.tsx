  ...
  return (
    <>
      ...
      <main>
        ...
        <h1 className="page-title">Der Ablauf steht.</h1>
              ...
              <article className="card plan-item" key={item.slotId}>
                ...
                <div className="plan-item-main">
                  ...
                  <form action={updatePlanSlot} className="plan-edit-form">
                    ...
                    <label>kg je Hantel<input name="weightKg" type="number" step="0.5" min="0" defaultValue={item.weightGrams / 1000} aria-label={`Gewicht für ${exercise.shortName}`} /></label>
